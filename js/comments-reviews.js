...
function createCommentCard(comment) {
    ...
    article.classList.add("film-chaser", "card-comments");
    ...
    img.src =
        comment.author_details.avatar_path || "https://via.placeholder.com/50";
    img.alt = "User Image";
    img.width = 50;
    img.height = 50;
    ...
    metaDiv.classList.add("js-comment-name-date");
    ...
    // Wrap person image, name and comment's date into one div
    var imgAndMetaInfoDiv = document.createElement("div");
    imgAndMetaInfoDiv.classList.add("js-comment-meta-info");
    imgAndMetaInfoDiv.appendChild(img);
    imgAndMetaInfoDiv.appendChild(metaDiv);

    headerDiv.appendChild(imgAndMetaInfoDiv);
    ...
    starsDiv.classList.add("js-comment-rating");
